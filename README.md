...
* **🚀 Fully Automated Build**: Checks the official Zen Browser repository daily at **UTC 02:00**. If a new version (with a Windows installer) is released, it automatically downloads, extracts, repackages, and publishes it to the [Releases](https://github.com/CyLoiMe/Zen-Browser-Portable-Builder/releases) page of this repository.
...
#### Method 1: Standalone Use (USB / External Drive)
1.  Go to the [**Releases**](https://github.com/CyLoiMe/Zen-Browser-Portable-Builder/releases) page.
2.  Download the latest `ZenBrowserPortable_x.x.x.zip`.
...
When the launcher notifies you of a new version, follow these steps to update (**This keeps all your data safe**):
